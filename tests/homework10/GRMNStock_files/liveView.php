...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=103343&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=[SUBID_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed1d46rtyvqzno&csuuid=60c1a925a3c44&r_csuuid=1&cbuster=1623304485',
					origQString: 's=103343&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=[SUBID_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed1d46rtyvqzno',
					placementId: 103343,
					x: 539,
					y: 303,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"89.0","browserVersionMajor":"89","browserVersionMinor":"0","chromeVersion":""},"browser":"firefox","os":"windows","osVer":"","deviceType":"desktop"},
					isFpCookie: 1,
					geo: 'RU',
					dmaCode: 0,
					dynamicSetup: [],
